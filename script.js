...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayaanggg", "Aku ada pertanyaan nih buat kamu bebb", "question").then(function () {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Iya ${sender} juga kangen ${nama}, makasihhh yaa`).then(function () {
                          Swal.fire('Terakhir deh sayanggg').then(function () {
